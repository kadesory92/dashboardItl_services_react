    ...
    return (
        <div>
            <div id="layoutSidenav_nav">
                <nav className="sb-sidenav accordion text-dark sb-sidenav-dark bg-primary" id="sidenavAccordion">
                    <div className="sb-sidenav-menu">
                        <div className="nav">
                            ...
                            <div className="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                ...
                                <Link className="nav-link" to="create-category">Add Post</Link>
                                    <Link className="nav-link" to="list-categories">List of posts</Link>

                                    <Link className="nav-link" to="create-post">Show comments</Link>
                                </nav>
                            </div>

                            <Link className="nav-link collapsed" to="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                <div className="sb-nav-link-icon"><i class="bi bi-journal-album"></i></div>
                                    Albums Management
                                <div className="sb-sidenav-collapse-arrow"><i className="fas fa-angle-down"></i></div>
                            </Link>
                            <div className="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav className="sb-sidenav-menu-nested nav">
                                <Link className="nav-link" to="create-category">Add Album</Link>
                                    <Link className="nav-link" to="list-categories">List of Albums</Link>
                                </nav>
                            </div>

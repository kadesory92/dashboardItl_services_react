...
const ListPhotos = () => {
  ...
  const fetchPhotos = async () => {
    try {
      ...
      const pitctures = res.data.slice(0, 3);

      setPhotos(pitctures);
    } catch (error) {
      console.error("Erreur de récupération de photos", error);
    }
  };
                  ...
                  <div class="row g-0">
                    <div class="col-md-8">
                      <div class="card-body">
                        ...
                        <Link>
                          <span className="mx-2">aaaaaa</span>
                        </Link>
                      </div>
                    </div>
                    <div class="col-md-4 me-0">
                      <img
                        src={photo.url}
                        class="img-fluid rounded-start h-50 ms-0 mx-4 mt-5 my-4"
                        alt="..."
                      />
                    </div>
                  </div>
